...
const en = {
  ...
  starter: {
    ...
    description: 'Choose a character and a story independently. Start blank on either side if you want the agent to create it with you.',
  ...
  create: {
    ...
    title: 'Finish your Companion',
    description: 'Your character and starting point are ready. Ask ChatGPT to build the story, tasks, and progress for this Companion.',
    character: 'Character',
    story: 'Story & tasks',
    blankStory: 'Blank — ChatGPT will create it',
    promptLabel: 'In ChatGPT, send:',
    prompt: 'Finish creating my Companion.',
    waiting: 'A valid draft will open here for your review.',
  },
  navigation: {
