...
const en = {
  ...
  characters: {
    title: 'Characters',
    description: 'Create, edit, publish, and export reusable local characters.',
    saved: 'Your characters',
    new: 'Create a character',
    draft: 'Draft',
    published: 'Published · v{{version}}',
    unpublishedChanges: 'Published v{{version}} · Unpublished changes',
    edit: 'Edit',
    delete: 'Delete',
    deleteTitle: 'Delete this character?',
    deleteDescription: 'Delete {{name}} from this device? Published packs already embedded elsewhere are not affected.',
    loadError: 'Character starters could not be loaded.',
    story: {
      title: 'Story mode',
      description: 'Stories and gameplay are outside this competition build.',
