...
export async function exportCharacterDraftZip(draft: CharacterDraft, experience?: ExperienceDraft | null): Promise<Blob> {
  ...
  files['README.md'] = strToU8('# Companion Authoring Draft\n\nLossless local workspace backup. `character-pack.json` is included only when this draft is ready to install.\n')
