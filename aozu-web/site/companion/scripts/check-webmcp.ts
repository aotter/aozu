...
assert.deepEqual(names.sort(), [
  'inspect_aozu_adventure_scores', 'inspect_aozu_capabilities', 'inspect_character_contract', 'inspect_companion', 'open_aozu_dialogue', 'resolve_companion_turn',
  'stage_aozu_ability_card', 'stage_aozu_life_event', 'stage_aozu_memory', 'stage_aozu_outfit', 'stage_aozu_trip_plan', 'start_aozu_activity',
