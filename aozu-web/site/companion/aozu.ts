...
export const AOZU_PARTNERS = [
  { id: 'otter', kind: 'mascot', name: 'AOZU · 布丁獺', displayName: '布丁獺', role: '生活探險家', image: '/assets/mascot-otter-v1.png', accent: '#e6454f', personality: '開朗、黏人、行動派', quote: '今天想先從哪一件小事開始？', capabilities: ['計步與健身', '旅行任務', '換裝成長'] },
  { id: 'seal', kind: 'mascot', name: 'AOZU · 泡泡海豹', displayName: '泡泡海豹', role: '飲食應援員', image: '/assets/mascot-seal-v1.png', accent: '#5fa9d5', personality: '溫柔、樂觀、懂得傾聽', quote: '好好吃飯，也是一種了不起的冒險。', capabilities: ['飲控紀錄', '美食日誌', '生活陪伴'] },
  ...
  { id: 'space', kind: 'human', name: 'AOZU · 電獺少女・Space', displayName: 'Space', role: '星系生活策展人', image: '/assets/aotter-girl-space-hd-v2.png', accent: '#70a8bd', personality: '溫柔、靈敏、想像力豐富', quote: '把想法交給我，我們一起找到最閃亮的路線。', capabilities: ['共同筆記', '語言學習', '旅行靈感'] },
