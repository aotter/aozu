...
挑戰賽服務名稱：**AOZU Companion Forge｜AOZU 虛擬夥伴創生與任務養成系統**
挑戰賽標語：**Create a companion. Give it a quest. Grow together.**
...
互動式 RWD Web 位於 [`site/`](site/)，主畫面是夥伴房間與遊戲 HUD，不採一般網站式 Dashboard。P0 主線是 Companion Forge：從七個高解析角色版型建立一位有自訂名字、個性、定位、能力、誕生配件與三步 Origin Quest 的虛擬夥伴。完成旅行、健身、計步、飲控、記帳或共同寫作的三次真實互動後，會解鎖並穿上任務配件、保存第一場共同記憶，再封成可召回角色與能力的 Origin Card。
...
- 第一條跨模組展示故事是「創造夥伴、完成第一場三步任務、得到配件並封成 Origin Card」；旅行、健身、計步、飲控、記帳與共筆只是可替換的任務內容。
