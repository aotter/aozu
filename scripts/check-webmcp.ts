...
registerCompanionTools(document, { async inspect() {}, async inspectCharacter() {}, async submit() {}, async resolve() {} })
await Promise.resolve()
assert.deepEqual(names.sort(), ['inspect_character_contract', 'inspect_companion', 'resolve_companion_turn', 'submit_companion_action'])
