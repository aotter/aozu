...
assert.deepEqual(names.sort(), ['inspect_character_contract', 'inspect_companion', 'resolve_companion_turn', 'submit_character_asset_candidate', 'submit_companion_action'])
