...
assert.equal(candidate.record.identity.templateVersion, '2')
assert.equal(candidate.record.identity.contractVersion, 2)
assert.deepEqual(candidate.record.identity.contractVersion === 2 ? candidate.record.identity.loopIds : [], draft.seed.loopIds)
